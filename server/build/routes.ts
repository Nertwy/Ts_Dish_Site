...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.post('/register/register',
            ...(fetchMiddlewares<RequestHandler>(Register)),
            ...(fetchMiddlewares<RequestHandler>(Register.prototype.Register)),

            function Register_Register(request: any, response: any, next: any) {
            const args = {
